                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="handphone">No.Telepon Client</label>
                                <input type="text" class="form-control" name="handphone" id="handphone" placeholder="No.Telepon Client"
                                    required>
                            </div>
                            <div class="form-group">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($widget['kon'] as $k)
                                <tr>
                                    <td scope="row">{{ $loop->iteration }}</td>
                                    <td>{{ $k->user->name }}</td>
                                    <td>{{ $k->name }}</td>
                                    <td>{{ $k->handphone }}</td>
                                    <td>{{ $k->status_konsumen }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
